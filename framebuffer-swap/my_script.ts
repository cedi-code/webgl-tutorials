...
const targetTextureWidth : number = gl.canvas.width / 2.0;
const targetTextureHeight : number = gl.canvas.height / 2.0;
...
function drawCube(program : WebGLProgram | null, attribSetter : AttributeSetter, uniSetter : UniformSetter, buffer : BufferInfo, uniforms : UniformData) 
{
