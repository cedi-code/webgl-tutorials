...
function createTruncatedCone(bottomRadius = 1, topRadius = 0.5, height = 1, radialSegments = 16, heightSegments = 1) {
    const positions = [];
    const normals = [];
    const texCoords = [];
    const indices = [];
...
export { createCube, createSphere, createTruncatedCone };
// Example usage:
/*
